...
Its Phase 1 surface exposes the packed-polynomial bridge
`Hex.GF2Poly ≃+* Hex.FpPoly 2` together with the corresponding
single-word/arbitrary-degree `GF(2^n)` bridge modules.
-/
