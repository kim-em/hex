...
the Phase 1 extended-GCD, Barrett, and Montgomery reduction layers,
including the Nat and `UInt64` extended-GCD surfaces, the inverse,
`UInt64`, and pure-`Nat` REDC Montgomery scaffolds, plus the modular
